...
star_light_dream2()
{
	...
	imgSetCurrent(txt);
	imgFill(0, 0, 0);
	bg = imgLoad("bg3.png", 0, 0);
	imgSetCurrent(bg);
	imgSetPos(x0, y0);
	imgSetCurrent(txt);
	txtSetColor(255, 255, 255);
	txtOut("¯‚ğ”ğ‚¯‚ÄƒS[ƒ‹‚Ös‚±‚¤");
	txtSetPos(500, 0);
	txtOut("ƒS[ƒ‹500");
	img = imgLoad("hosi_hai.png", 2, 0);
	img2 = imgLoad("star1_hai.png", 3, 0);
	img3 = imgLoad("block_hai.png", 4, 0);
	img4 = imgLoad("star1_hai.png", 5, 0);
	img6 = imgLoad("block_hai.png", 6, 0);
	img8 = imgLoad("star2_hai.png", 5, 0);
	img9 = imgLoad("star3_hai.png", 9, 0);
	img10 = imgLoad("block_hai.png", 10, 0);
	img11 = imgLoad("block_hai.png", 11, 0);
	img12 = imgLoad("block_hai.png", 12, 0);
	img13 = imgLoad("block_hai.png", 13, 0);
